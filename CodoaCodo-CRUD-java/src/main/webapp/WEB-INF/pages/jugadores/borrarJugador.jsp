            ...
            <div class="col-sm-5 col-md-6 col-lg-4">
                ...
                <form action="${pageContext.request.contextPath}/arma-tu-equipo?accion=remove&id=${jugadorABorrar.id}"
                    ...
                    <div class="row text-center">
                        ...
                        <div class="col-12">
                            <!-- Todos los enlaces envian peticiones get!! 
                            Submit es la confirmación de envio de un formulario con el metodo Post-->
                            <a href="${pageContext.request.contextPath}/arma-tu-equipo" class="btn btn-secondary">Mejor no</a>
